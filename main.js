...
function addCube()
{
    ...
    let materialArray = [
    new THREE.MeshStandardMaterial( { map: loader.load("https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/soham.png") } ),
    new THREE.MeshStandardMaterial( { map: loader.load("https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/soham.png") } ),
    new THREE.MeshStandardMaterial( { map: loader.load("https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/soham.png") } ),
    new THREE.MeshStandardMaterial( { map: loader.load("https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/soham.png") } ),
    new THREE.MeshStandardMaterial( { map: loader.load("https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/soham.png") } ),
...
const sprite = new THREE.TextureLoader().load('https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/star.png');
...
function addMoon()
{
    ...
    const moonTexture = new THREE.TextureLoader().load('https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/plutomap2k.jpg'); 
    const normalTexture = new THREE.TextureLoader().load('https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/plutobump2k.jpg'); 
...
function addJupiter(){
    ...
    const jupiterTexture = new THREE.TextureLoader().load('https://github.com/SohamSinghal/MyPortfolio/tree/master/asset/jupitermap.jpg'); 
